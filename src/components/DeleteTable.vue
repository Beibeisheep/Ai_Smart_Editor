...
export default defineComponent({
	...
	setup() {
		...
		const fetchData = () => {
			$.ajax({
				url: 'http://192.168.1.5:8083/TextEditor/file/getRecycleBinFileInfo',
				type: 'POST',
				dataType: 'json',
				success: (response) => {
		...
		const deleteAllFiles = () => {
			...
			$.ajax({
				url: 'http://192.168.1.5:8083/TextEditor/file/deleteFiles',
				type: 'POST',
				dataType: 'json',
		...
		const handleRestoreMultiple = () => {
			...
			$.ajax({
				url: 'http://192.168.1.5:8083/TextEditor/file/recoverFile',
				type: 'POST',
				contentType: 'application/json',
