...
export default defineComponent({
	...
	setup() {
		...
		const fetchData = () => {
			$.ajax({
				url: 'http://localhost:8083/TextEditor/file/getRecycleBinFileInfo',
				type: 'POST',
				dataType: 'json',
				success: (response) => {
		...
		const deleteAllFiles = () => {
			...
			$.ajax({
				url: 'http://localhost:8083/TextEditor/file/deleteFiles',
				type: 'POST',
				dataType: 'json',
		...
		const handleRestoreMultiple = () => {
			...
			$.ajax({
				url: 'http://localhost:8083/TextEditor/file/recoverFile',
				type: 'POST',
				contentType: 'application/json',
